    ...
    <footer id="footer" className="w-full py-3 md:py-12">
      <div className="px-6 xl:px-0 w-full max-w-[1440px] mx-auto relative">
        <div className=" flex flex-col lg:flex-row w-full">
          ...
          <div className="grow border-x lg:border-x-0 lg:border-y border-slate-700 py-6 px-6 sm:px-9">
          ...
          <div className="flex-none rounded-b-xl lg:rounded-b-none lg:!rounded-r-xl py-6 px-6 sm:px-12 border-l lg:border-l-0 border-r border-b lg:border-t border-slate-700">
