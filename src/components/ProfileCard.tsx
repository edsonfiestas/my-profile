    ...
    <>
      <main className="w-full max-w-md bg-white dark:bg-gray-900 shadow-2xl shadow-gray-400 dark:shadow-black/50 rounded-3xl overflow-hidden transition-colors duration-500">
        ...
        <div className="px-5 pb-5 pt-2">
          <button
            ...
            className="w-full mb-5 py-3 bg-blue-500 hover:bg-blue-600 rounded-xl text-white font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 cursor-pointer"
          >
            My Work
          ...
          <button
            ...
            className="w-full py-3 bg-emerald-500 hover:bg-emerald-600 rounded-xl text-white font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/25 cursor-pointer"
          >
            Contact Me
            <Icon d={ICONS.envelope} className="w-5 h-5" />
          </button>
        </div>
      </main>
      ...
      {contactModalOpen && (
        ...
        >
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" />
          <div
            className="relative bg-white dark:bg-gray-900 rounded-2xl p-6 max-w-lg w-full shadow-2xl animate-slideUp max-h-[90vh] overflow-y-auto custom-scrollbar"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              onClick={() => setContactModalOpen(false)}
              ...
              <div className="flex flex-col gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-blue-400 dark:focus:border-blue-500 transition-colors duration-200"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-blue-400 dark:focus:border-blue-500 transition-colors duration-200 resize-none"
                  />
                </div>
                <a
                  href={`mailto:edsonfiestas@gmail.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`}
                  className="w-full py-2.5 bg-blue-500 hover:bg-blue-600 rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25"
                >
                  Send Email
                  <Icon d={ICONS.paperAirplane} className="w-4 h-4" />
                </a>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-3">
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-green-400 dark:focus:border-green-500 transition-colors duration-200 resize-none"
                  />
                </div>
                <a
                  href={`https://wa.me/51947887843?text=${encodeURIComponent(whatsappMessage)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-2.5 bg-[#25D366] hover:bg-[#1fb855] rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25"
                >
                  Send WhatsApp
                  <Icon d={ICONS.paperAirplane} className="w-4 h-4" />
                </a>
