  ...
  return (
    <>
      <main className="w-full max-w-md bg-white dark:bg-gray-900 shadow-2xl shadow-gray-400 dark:shadow-black/50 rounded-3xl overflow-hidden transition-colors duration-500">
        ...
        {/* ── Contact Row ── */}
        <div className="flex items-center gap-2 px-5 pb-5 mt-6">
          <a
            href="mailto:edsonfiestas@gmail.com"
            className="flex-1 py-2.5 bg-blue-500 hover:bg-blue-600 rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-1.5 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25"
          >
            <Icon d={ICONS.envelope} className="w-4 h-4" />
            Email
          </a>
          <a
            href="https://wa.me/51947887843"
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 py-2.5 bg-[#25D366] hover:bg-[#1fb855] rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-1.5 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <a
            href="https://www.upwork.com/freelancers/~01d94b95b6e6a940c4"
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 py-2.5 bg-[#14a800] hover:bg-[#108a00] rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-1.5 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
